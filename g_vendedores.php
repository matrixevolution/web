...
<html lang="es">
    ...
    if (isset($_POST["btn1"])) {
        ...
        if ($btn == "Buscar") {
            ...
            $sql = "select * from vendedores where id='$bus'";
        ...
        if ($btn == "Agregar") {
            ...
            $nom = $_POST["txttel"];
            $dir = $_POST["txtdir"];
            $sql = "insert into transportista values ('$id','$nom','$pre','$des')";
        ...
        if ($btn == "Actualizar") {
            ...
            $sql = "update vendedores set telefono='$tel',clave='$clv',nombre='$nom','direccion='$dir' where id='$id'";
            ...
            <div id="b">
                <article>
                    ...
                    <form name="fe" action="" method="post">                      
                        ...
                        <textarea name="txtdir"><?php echo $var4 ?></textarea>
                        <p>
                    ...
                    if (isset($_POST["btn1"])) {
                        ...
                        if ($btn == "Listar") {
                            ...
                            echo"<center>
<table>
<caption>Listado de Vendedores</caption>
<tbody>
<tr>
<th>ID</th>
<th>Teléfono</th>
